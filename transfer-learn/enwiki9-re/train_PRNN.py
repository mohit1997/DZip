...
def fit_model(X, Y, bs, nb_epoch, preprocessor, num_classes):
    ...
    optim = keras.optimizers.Adam(lr=5e-3, beta_1=0.9, beta_2=0.999, epsilon=None, amsgrad=False, clipnorm=0.1, decay=decayrate)
...
def get_argument_parser():
    ...
    parser.add_argument('--file_name', type=str, default='enwik9',
