...
def fit_model(X, Y, bs, nb_epoch, student, teacher):
    ...
    optim = keras.optimizers.Adam(lr=5e-3, beta_1=0.9, beta_2=0.999, epsilon=None, amsgrad=False, decay=decayrate)
...
def biGRU_big(bs,time_steps,alphabet_size):
  ...
  x = Bidirectional(CuDNNGRU(64, stateful=False, return_sequences=False))(x)
