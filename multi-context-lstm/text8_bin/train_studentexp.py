...
def fit_model(X, Y, bs, nb_epoch, student, teacher):
    ...
    checkpoint = ModelCheckpoint("model_studentexp" ,monitor='loss', verbose=1, save_best_only=True, mode='min', save_weights_only=True)
    csv_logger = CSVLogger("log_studentexp.csv", append=True, separator=';')
